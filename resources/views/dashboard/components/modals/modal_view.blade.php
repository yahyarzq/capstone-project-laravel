                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="modal-form-view-Profil" name="Profil" class="form-control">
                                <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-Pengusul">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputName">Urusan</label>
                                <input type="text" id="modal-form-view-Urusan" name="Urusan" class="form-control">
                                <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-Urusan"></div>
                            </div>
                            <div class="form-group">
                                <label for="inputDescription">Usulan</label>
                                <textarea id="modal-form-view-Usulan" name="Usulan" class="form-control" rows="4"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="modal-form-view-Permasalahan" name="Permasalahan" class="form-control" rows="4"></textarea>
                                <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-Permasalahan">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputName">Alamat</label>
                                <input type="text" id="modal-form-view-Alamat" name="Alamat" class="form-control">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="modal-form-view-Rekomendasi_Bappeda" name="Rekomendasi_Bappeda" class="form-control" rows="4"></textarea>
                                <div class="alert alert-danger mt-2 d-none" role="alert" id="alert-content">
                                </div>
                            </div>
                            <div class="form-group">
